    ...
    <div style={{
      ...
      {EMOTIONS.map((em) => (
        <div key={em.name} style={{
          ...
          borderRadius: 5,
          marginBottom: 4,
          background: em.name === emotion ? em.color + "22" : "transparent",
          border: `1px solid ${em.name === emotion ? em.color + "44" : "transparent"}`,
          transition: "all 0.3s"
        }}>
          <div style={{
            width: 6,
            height: 6,
            borderRadius: "50%",
            background: em.name === emotion ? em.color : "#1e293b"
          }} />
          <span style={{
            fontSize: 11,
            fontFamily: "monospace",
            color: em.name === emotion ? em.color : "#475569"
          }}>
            {em.name}
          </span>
        </div>
